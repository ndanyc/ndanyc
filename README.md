...
<div id="russian">
  ...
  <hr>
  <h3 align="center">🇷🇺 Обо мне (Русская версия) </h3>

  <p align="center"> <b>Привет! Я Даниил (ndanyc).</b> </p>
  ...
  После того как я освою основы QA, я планирую углубиться в **CyberSecurity**.  
  Меня привлекает романтика хакерства, исследование уязвимостей и то, как системы защищены (или взламываются).

  ---

  ### 📂 Моё портфолио QA

  Все мои практические наработки, баг-репорты и опыт тестирования Web3:  
